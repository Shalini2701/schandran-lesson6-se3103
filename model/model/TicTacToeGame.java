...
public class TicTacToeGame {
    ...
    private Marking turn = Marking.X; // Xstarts first
    private int moves = 0;
    private Marking winner = null; // 0 or X or U [draw]
    ...
    public String toString() {
        var r1 = String.format("%s %s %s", board[0], board[1], board[2]);
        var r2 = String.format("%s %s %s", board[3], board[4], board[5]);
        var r3 = String.format("%s %s %s", board[6], board[7], board[8]);
        var r4 = String.format("Winner: %s (moves: %d)", winner, moves);
        return r1 + r2 + r3 + r4;
    }
}
